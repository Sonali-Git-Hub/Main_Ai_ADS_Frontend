...
export const DashboardModule = () => {
  ...
  return (
    <div className="space-y-6 animate-in fade-in">
      {/* Banner */}
      <div className="p-6 rounded-3xl bg-gradient-to-r from-brand-50 via-white to-purple-50 dark:from-brand-900/60 dark:via-slate-900 dark:to-purple-950/60 border border-brand-200 dark:border-brand-500/30 shadow-2xl relative overflow-hidden flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div className="relative z-10 space-y-1">
          <div className="flex items-center gap-2">
            <span className="text-xs uppercase font-extrabold tracking-widest text-brand-600 dark:text-brand-400 bg-brand-500/10 dark:bg-brand-500/20 px-2.5 py-0.5 rounded-full">Canonical Overview</span>
            <span className="text-xs text-slate-500 dark:text-slate-400">Operating Model: Brand → Strategy → SEO → Create → Approve → Publish</span>
          </div>
          <h1 className="text-2xl font-extrabold text-slate-800 dark:text-white">AI Ads™ Operations Hub</h1>
          <p className="text-xs text-slate-600 dark:text-slate-300 max-w-xl">
            Currently governing <strong className="text-slate-800 dark:text-white">{activeWorkspace.brandName}</strong> ({activeWorkspace.domainUrl}). All AI output is anchored to immutable Brand DNA positioning.
          </p>
        </div>
          ...
          return (
            <div key={idx} className={`p-4 rounded-2xl glass-card border ${s.bg} flex items-center justify-between`}>
              <div>
                ...
                <div className="text-2xl font-extrabold text-slate-800 dark:text-white my-0.5">{s.value}</div>
                <span className="text-[10px] text-slate-500 dark:text-slate-400">{s.sub}</span>
              </div>
      ...
      <div className="p-6 rounded-3xl glass-card border border-slate-200 dark:border-slate-800 space-y-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
          ...
          >
            <div className="w-8 h-8 rounded-xl bg-brand-500/10 dark:bg-brand-500/20 text-brand-600 dark:text-brand-400 flex items-center justify-center mb-2 group-hover:scale-110 transition-transform">
              <Dna className="w-4 h-4" />
            </div>
            <span className="text-xs font-bold text-slate-800 dark:text-white block">1. Brand DNA</span>
            <span className="text-[10px] text-slate-500 dark:text-slate-400">Positioning & Claims</span>
          </button>
          ...
          <button 
            ...
            className="p-4 rounded-2xl bg-slate-50 dark:bg-slate-900/60 border border-slate-200 dark:border-slate-800 hover:border-brand-500/50 transition-all text-left group"
          >
            <div className="w-8 h-8 rounded-xl bg-cyan-500/10 dark:bg-cyan-500/20 text-cyan-600 dark:text-cyan-400 flex items-center justify-center mb-2 group-hover:scale-110 transition-transform">
              <Search className="w-4 h-4" />
            </div>
            <span className="text-xs font-bold text-slate-800 dark:text-white block">2. SEO Briefs</span>
            <span className="text-[10px] text-slate-500 dark:text-slate-400">Topic Clusters & Intent</span>
          </button>
          ...
          <button 
            ...
            className="p-4 rounded-2xl bg-slate-50 dark:bg-slate-900/60 border border-slate-200 dark:border-slate-800 hover:border-brand-500/50 transition-all text-left group"
          >
            <div className="w-8 h-8 rounded-xl bg-purple-500/10 dark:bg-purple-500/20 text-purple-600 dark:text-purple-400 flex items-center justify-center mb-2 group-hover:scale-110 transition-transform">
              <PenTool className="w-4 h-4" />
            </div>
            <span className="text-xs font-bold text-slate-800 dark:text-white block">3. Editorial Studio</span>
            <span className="text-[10px] text-slate-500 dark:text-slate-400">8-Step Draft & Fact Check</span>
          </button>
          ...
          <button 
            ...
            className="p-4 rounded-2xl bg-slate-50 dark:bg-slate-900/60 border border-slate-200 dark:border-slate-800 hover:border-brand-500/50 transition-all text-left group"
          >
            <div className="w-8 h-8 rounded-xl bg-emerald-500/10 dark:bg-emerald-500/20 text-emerald-600 dark:text-emerald-400 flex items-center justify-center mb-2 group-hover:scale-110 transition-transform">
              <CheckCircle2 className="w-4 h-4" />
            </div>
            <span className="text-xs font-bold text-slate-800 dark:text-white block">4. Approvals Desk</span>
            <span className="text-[10px] text-slate-500 dark:text-slate-400">Role Sign-off & Client Portal</span>
          </button>

          <button 
            onClick={() => setActiveModule('repurpose')}
            className="p-4 rounded-2xl bg-slate-50 dark:bg-slate-900/60 border border-slate-200 dark:border-slate-800 hover:border-brand-500/50 transition-all text-left group col-span-2 md:col-span-1"
          >
            <div className="w-8 h-8 rounded-xl bg-amber-500/10 dark:bg-amber-500/20 text-amber-600 dark:text-amber-400 flex items-center justify-center mb-2 group-hover:scale-110 transition-transform">
              <Repeat className="w-4 h-4" />
            </div>
            <span className="text-xs font-bold text-slate-800 dark:text-white block">5. Repurposing</span>
            <span className="text-[10px] text-slate-500 dark:text-slate-400">1 Asset to 5 Formats</span>
          </button>
        </div>
      </div>
