    ...
    <div className="space-y-5 animate-in fade-in">
      ...
      {keywordsList.length === 0 ? (
        <div className="text-center py-20 rounded-3xl glass-card border border-dashed border-slate-200 dark:border-slate-800 mt-6">
          ...
          <h3 className="text-lg font-extrabold text-slate-900 dark:text-white mb-2">Initialize SEO Cluster Intelligence</h3>
          <p className="text-sm text-slate-500 dark:text-slate-400 max-w-md mx-auto mb-6">
            Generate keyword clusters, search intent profiles, and topic maps anchored to your Brand DNA.
          </p>
          <button onClick={handleInitializeSEO} className="btn-primary text-sm flex items-center gap-2 mx-auto px-6 py-2.5 rounded-xl shadow-lg shadow-cyan-500/20 hover:scale-105 active:scale-95 transition-all">
            <Sparkles className="w-4 h-4 text-amber-300 fill-amber-300" /> Initialize SEO Pipeline
          </button>
        </div>
      ) : (
        <>
