    ...
    <div className="space-y-6 animate-in fade-in">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="p-6 rounded-3xl glass-card border border-slate-800 space-y-4">
          <h2 className="text-sm font-bold text-white uppercase tracking-wider">Objectives & Conversion Path</h2>

          <div>
            <label className="block text-xs font-bold text-slate-300 mb-1">Primary Business Goal</label>
            <input 
              type="text"
              value={businessGoal}
          ...
          <div>
            <label className="block text-xs font-bold text-slate-300 mb-1">Lead Magnet / Conversion Offer</label>
            <input 
              type="text"
              value={leadMagnet}
          ...
          <div className="p-4 rounded-2xl bg-slate-900/60 border border-slate-800 space-y-2">
            <span className="text-xs font-bold text-brand-400 block">Publishing Channel Mix:</span>
            <div className="space-y-1 text-xs">
              <div className="flex justify-between text-slate-300"><span>SEO Blogs (Long-Form)</span><span className="font-bold">40%</span></div>
              <div className="flex justify-between text-slate-300"><span>LinkedIn & Founder Copy</span><span className="font-bold">30%</span></div>
              <div className="flex justify-between text-slate-300"><span>Email Newsletters</span><span className="font-bold">20%</span></div>
              <div className="flex justify-between text-slate-300"><span>Instagram & Reels Copy</span><span className="font-bold">10%</span></div>
            </div>
          </div>
        </div>
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          {generatedDoc && (
            <div className="p-6 rounded-3xl bg-brand-950/40 border border-brand-500/40 space-y-3 animate-in fade-in">
              <div className="flex items-center justify-between">
