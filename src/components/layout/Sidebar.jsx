...
export const Sidebar = () => {
  ...
  const modules = [
    ...
    { id: 'websiteBuilder', label: t('websiteBuilder', '12. AI Website Builder'), icon: Globe },
  ...
  return (
    <>
      ...
      <div>
        {/* Logo Header */}
        <div className="h-16 flex items-center justify-between px-3.5 border-b border-slate-200 dark:border-slate-800/80">
          <button 
            onClick={() => {
              if (isMobileMenuOpen) {
            ...
            {(!collapsed || isMobileMenuOpen) && (
              <div className="min-w-0 flex-1">
                <div className="flex items-center gap-1">
                  <span className="font-bold text-slate-800 dark:text-white text-base tracking-wide truncate">AI Ads™</span>
        ...
        <div className="px-4 py-3 flex items-center justify-center gap-3 border-b border-slate-100 dark:border-slate-800/40">
        ...
        <nav className="px-2 py-2 space-y-0.5 flex-1 overflow-y-auto [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden">
          {modules.map((m) => {
            const Icon = m.icon;
